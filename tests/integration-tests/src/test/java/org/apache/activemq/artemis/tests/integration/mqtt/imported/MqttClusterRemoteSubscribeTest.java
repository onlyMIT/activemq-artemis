...
public class MqttClusterRemoteSubscribeTest extends ClusterTestBase {
   ...
   public void useSameClientIdAndAnycastSubscribeRemoteQueue() throws Exception {
      ...
      try {
         ...
         // Subscribe to topics
         subConnection1.subscribe(topics);
         //Waiting for the notification processing between cluster nodes to be completed
         Thread.sleep(2000);
         ...
         //the first sub connection will be closed
         assertFalse(subConnection1.isConnected());
   ...
   public void useSameClientIdSubscribeRemoteQueueMultipleSubscriptions() throws Exception {
      ...
      try {
         ...
         // Subscribe to topics
         subConnection1.subscribe(new Topic[]{new Topic(ANYCAST_TOPIC, QoS.AT_MOST_ONCE)});
   ...
   public void useSameClientIdSubscribeExistingQueue() throws Exception {
      ...
      try {
         ...
         //the second sub connection will be closed, when the third sub connection is connected
         assertFalse(subConnection2.isConnected());
         ...
         //the first sub connection also will be closed
         assertFalse(subConnection1.isConnected());
